...
class Test(TestCase):
    def test_name_and_phone_number(self):
        self.assertEqual(name_and_phone_number(), "Hello, Michael, is 1234 your phone number?")

    def test_what_type_does_input_return(self):
        self.assertEqual(what_type_does_input_return(), "69")

    def test_add_your_two_favorite_numbers(self):
        self.assertEqual(add_your_two_favorite_numbers(), f"The sum of your favorite numbers is 3")
